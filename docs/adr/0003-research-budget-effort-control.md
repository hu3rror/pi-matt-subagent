...
> **Revised by ADR-0008**: the 100% line now issues a final notice + grace period, findings are checkpoint-written, and the tier table is recalibrated. See ADR-0008 for current semantics.
